...
knife4j:
  ...
  openapi:
    ...
    title: XXX 管理系统
    description: 提供 xxx 等全部后台管理功能的 API
    version: 1.0.0
    concat:
      name: XXX 团队
      email: xxx@example.com
    license: MIT
    license-url: https://github.com/yourname/xxx/blob/main/LICENSE
    group:
      default:
        group-name: 管理后台
        api-rule: package
        api-rule-resources:
          - { name: XXX管理, package-path: com.example.xxx.controller }
